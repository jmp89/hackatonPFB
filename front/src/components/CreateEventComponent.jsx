...
const CreateEventComponent = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const themsArray = formDataEvent.thematics
                .split(',')
                .map((them) => them.trim());
            const techsArray = formDataEvent.technologies
                .split(',')
                .map((tech) => tech.trim());
                    ...
                    <section className="m-6 mb-10 flex flex-col">
                        ...
                        <section>
                            <input
                                ...
                                name="thematics"
                                required
                                placeholder="varias temáticas separadas por ', '"
                        ...
                        <section>
                            <input
                                ...
                                name="technologies"
                                required
                                placeholder="varias tecnologías separadas por ', '"
