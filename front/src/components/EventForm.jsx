                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        <select
                            id="online_on_site"
                            name="online_on_site"
                            value={eventData.online_on_site}
                            onChange={handleChange}
                            className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black"
                            required
                        >
                    ...
                    <button
                        type="submit"
                        className="w-full bg-black text-white py-2 rounded-lg font-bold text-lg mb-4"
                    >
                        Submit
                    </button>
                </form>
