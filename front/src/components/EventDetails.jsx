...
const EventDetails = () => {
    ...
    return (
<main className="flex flex-col items-center justify-center px-4 py-3 xl2:px-8 xl2:py-6">
    ...
    <section className="relative w-full max-w-[900px] bg-white p-6 rounded-lg shadow-md mt-12 xl2:max-w-[70vw] xl2:p-8 xl2:mt-16">
        <div className="text-center">
            {event.organizer_name && (
                <p>
                    <span className="font-bold uppercase mt-4">ORGANIZADOR:</span>
                </p>
            )}
            {event.organizer_name && (
            ...
            <p>{event.thematics}</p>
            <p className="mt-3 xl2:mt-4">
                <span className="font-bold uppercase">TECNOLOGÍAS:</span>
            </p>
