...
const ListTechnologiesAndThematicsComponent = () => {
    ...
    const renderThematics = () => {
        ...
        return thematics.slice(start, end).map((them, index) => (
            <div
                key={index}
                className="rounded-lg border-2 border-border p-6 transition-transform transform hover:scale-105 hover:shadow-xl"
            >
    ...
    const renderTechnologies = () => {
        ...
        return technologies.slice(start, end).map((tech, index) => (
            <div
                key={index}
                className="rounded-lg border-2  p-6 transition-transform transform hover:scale-105 hover:shadow-xl"
            >
            ...
            <section className="py-12 md:py-16 h-auto lg:py-20 bg-zinc-800 text-white mt-10">
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    <p className="mt-4 max-w-3xl mx-auto text-lg leading-relaxed">
                        Explora las principales tecnologías y temáticas que
                        impulsan el desarrollo web y la innovación.
                    </p>
                </div>
            </section>
